...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserTaskDetailEvent);
}
...
/// @nodoc
class $UserTaskDetailEventCopyWith<$Res>  {
$UserTaskDetailEventCopyWith(UserTaskDetailEvent _, $Res Function(UserTaskDetailEvent) __);
}


/// Adds pattern-matching-related methods to [UserTaskDetailEvent].
extension UserTaskDetailEventPatterns on UserTaskDetailEvent {
...
class _GetTaskByIdEvent implements UserTaskDetailEvent {
...
/// Create a copy of UserTaskDetailEvent
...
@override
String toString() {
  return 'UserTaskDetailEvent.getTaskById(taskId: $taskId, deskId: $deskId, userId: $userId)';
}
...
/// @nodoc
abstract mixin class _$GetTaskByIdEventCopyWith<$Res> implements $UserTaskDetailEventCopyWith<$Res> {
...
class _PrayEvent implements UserTaskDetailEvent {
...
@override
String toString() {
  return 'UserTaskDetailEvent.pray(task: $task)';
}
...
/// @nodoc
abstract mixin class _$PrayEventCopyWith<$Res> implements $UserTaskDetailEventCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserTaskDetailState);
}
...
/// @nodoc
class $UserTaskDetailStateCopyWith<$Res>  {
$UserTaskDetailStateCopyWith(UserTaskDetailState _, $Res Function(UserTaskDetailState) __);
}


/// Adds pattern-matching-related methods to [UserTaskDetailState].
extension UserTaskDetailStatePatterns on UserTaskDetailState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _LoadingState implements UserTaskDetailState {
  const _LoadingState();
...
@override
String toString() {
  return 'UserTaskDetailState.loading()';
}
...
class _LoadedState implements UserTaskDetailState {
  const _LoadedState(this.task);
  

 final  TaskModel task;

/// Create a copy of UserTaskDetailState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
...
@override
String toString() {
  return 'UserTaskDetailState.loaded(task: $task)';
}
...
/// @nodoc
abstract mixin class _$LoadedStateCopyWith<$Res> implements $UserTaskDetailStateCopyWith<$Res> {
...
class _ErrorState implements UserTaskDetailState {
...
@override
String toString() {
  return 'UserTaskDetailState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorStateCopyWith<$Res> implements $UserTaskDetailStateCopyWith<$Res> {

...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserTasksEvent);
}
...
/// @nodoc
class $UserTasksEventCopyWith<$Res>  {
$UserTasksEventCopyWith(UserTasksEvent _, $Res Function(UserTasksEvent) __);
}


/// Adds pattern-matching-related methods to [UserTasksEvent].
extension UserTasksEventPatterns on UserTasksEvent {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _GetTasksByDeskIdEvent value)?  getTasksByDeskId,TResult Function( _PrayEvent value)?  pray,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _GetTasksByDeskIdEvent value)  getTasksByDeskId,required TResult Function( _PrayEvent value)  pray,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _GetTasksByDeskIdEvent value)?  getTasksByDeskId,TResult? Function( _PrayEvent value)?  pray,}){
final _that = this;
switch (_that) {
case _GetTasksByDeskIdEvent() when getTasksByDeskId != null:
return getTasksByDeskId(_that);case _PrayEvent() when pray != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int userId,  int deskId)?  getTasksByDeskId,TResult Function( TaskModel task)?  pray,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetTasksByDeskIdEvent() when getTasksByDeskId != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int userId,  int deskId)  getTasksByDeskId,required TResult Function( TaskModel task)  pray,}) {final _that = this;
switch (_that) {
case _GetTasksByDeskIdEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int userId,  int deskId)?  getTasksByDeskId,TResult? Function( TaskModel task)?  pray,}) {final _that = this;
switch (_that) {
case _GetTasksByDeskIdEvent() when getTasksByDeskId != null:
return getTasksByDeskId(_that.userId,_that.deskId);case _PrayEvent() when pray != null:
return pray(_that.task);case _:
...
class _GetTasksByDeskIdEvent implements UserTasksEvent {
...
/// Create a copy of UserTasksEvent
...
@override
String toString() {
  return 'UserTasksEvent.getTasksByDeskId(userId: $userId, deskId: $deskId)';
}
...
/// @nodoc
abstract mixin class _$GetTasksByDeskIdEventCopyWith<$Res> implements $UserTasksEventCopyWith<$Res> {
...
class _PrayEvent implements UserTasksEvent {
...
@override
String toString() {
  return 'UserTasksEvent.pray(task: $task)';
}
...
/// @nodoc
abstract mixin class _$PrayEventCopyWith<$Res> implements $UserTasksEventCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserTasksState);
}
...
/// @nodoc
class $UserTasksStateCopyWith<$Res>  {
$UserTasksStateCopyWith(UserTasksState _, $Res Function(UserTasksState) __);
}
...
class _Empty implements UserTasksState {
  const _Empty();
...
class _LoadingState implements UserTasksState {
  const _LoadingState();
...
class _LoadedState implements UserTasksState {
...
@override
String toString() {
  return 'UserTasksState.loaded(tasks: $tasks)';
}
...
/// @nodoc
abstract mixin class _$LoadedStateCopyWith<$Res> implements $UserTasksStateCopyWith<$Res> {
...
class _ErrorState implements UserTasksState {
...
@override
String toString() {
  return 'UserTasksState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorStateCopyWith<$Res> implements $UserTasksStateCopyWith<$Res> {

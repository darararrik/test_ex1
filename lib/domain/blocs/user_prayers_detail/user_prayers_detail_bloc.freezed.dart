...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserPrayerDetailEvent);
}
...
/// @nodoc
class $UserPrayerDetailEventCopyWith<$Res>  {
$UserPrayerDetailEventCopyWith(UserPrayerDetailEvent _, $Res Function(UserPrayerDetailEvent) __);
}


/// Adds pattern-matching-related methods to [UserPrayerDetailEvent].
extension UserPrayerDetailEventPatterns on UserPrayerDetailEvent {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _GetPrayerEvent value)?  getPrayerById,TResult Function( _PrayEvent value)?  pray,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _GetPrayerEvent value)  getPrayerById,required TResult Function( _PrayEvent value)  pray,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _GetPrayerEvent value)?  getPrayerById,TResult? Function( _PrayEvent value)?  pray,}){
final _that = this;
switch (_that) {
case _GetPrayerEvent() when getPrayerById != null:
return getPrayerById(_that);case _PrayEvent() when pray != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int prayerId)?  getPrayerById,TResult Function( PrayerModel prayer)?  pray,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetPrayerEvent() when getPrayerById != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int prayerId)  getPrayerById,required TResult Function( PrayerModel prayer)  pray,}) {final _that = this;
switch (_that) {
case _GetPrayerEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int prayerId)?  getPrayerById,TResult? Function( PrayerModel prayer)?  pray,}) {final _that = this;
switch (_that) {
case _GetPrayerEvent() when getPrayerById != null:
return getPrayerById(_that.prayerId);case _PrayEvent() when pray != null:
return pray(_that.prayer);case _:
...
class _GetPrayerEvent implements UserPrayerDetailEvent {
  const _GetPrayerEvent({required this.prayerId});
...
_$GetPrayerEventCopyWith<_GetPrayerEvent> get copyWith => __$GetPrayerEventCopyWithImpl<_GetPrayerEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetPrayerEvent&&(identical(other.prayerId, prayerId) || other.prayerId == prayerId));
}
...
@override
String toString() {
  return 'UserPrayerDetailEvent.getPrayerById(prayerId: $prayerId)';
}
...
/// @nodoc
abstract mixin class _$GetPrayerEventCopyWith<$Res> implements $UserPrayerDetailEventCopyWith<$Res> {
  factory _$GetPrayerEventCopyWith(_GetPrayerEvent value, $Res Function(_GetPrayerEvent) _then) = __$GetPrayerEventCopyWithImpl;
@useResult
$Res call({
 int prayerId
});
...
/// @nodoc
class __$GetPrayerEventCopyWithImpl<$Res>
    implements _$GetPrayerEventCopyWith<$Res> {
  __$GetPrayerEventCopyWithImpl(this._self, this._then);

  final _GetPrayerEvent _self;
  final $Res Function(_GetPrayerEvent) _then;
...
class _PrayEvent implements UserPrayerDetailEvent {
...
@override
String toString() {
  return 'UserPrayerDetailEvent.pray(prayer: $prayer)';
}
...
/// @nodoc
abstract mixin class _$PrayEventCopyWith<$Res> implements $UserPrayerDetailEventCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserPrayerDetailState);
}
...
/// @nodoc
class $UserPrayerDetailStateCopyWith<$Res>  {
$UserPrayerDetailStateCopyWith(UserPrayerDetailState _, $Res Function(UserPrayerDetailState) __);
}


/// Adds pattern-matching-related methods to [UserPrayerDetailState].
extension UserPrayerDetailStatePatterns on UserPrayerDetailState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _LoadingState implements UserPrayerDetailState {
  const _LoadingState();
...
@override
String toString() {
  return 'UserPrayerDetailState.loading()';
}
...
/// @nodoc
abstract mixin class _$LoadedStateCopyWith<$Res> implements $UserPrayerDetailStateCopyWith<$Res> {
...
class _ErrorState implements UserPrayerDetailState {
...
@override
String toString() {
  return 'UserPrayerDetailState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorStateCopyWith<$Res> implements $UserPrayerDetailStateCopyWith<$Res> {

...
class _CreateCommentEvent implements SubscribedDetailEvent {
...
@override
String toString() {
  return 'SubscribedDetailEvent.createComment(prayerId: $prayerId, body: $body)';
}
...
/// @nodoc
abstract mixin class _$CreateCommentEventCopyWith<$Res> implements $SubscribedDetailEventCopyWith<$Res> {
...
@override
String toString() {
  return 'SubscribedDetailState.loaded(prayer: $prayer, comments: $comments)';
}
